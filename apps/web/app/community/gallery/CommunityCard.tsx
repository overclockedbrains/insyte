...
const TYPE_CONFIG = {
  concept: {
    ...
    glowClass: 'hover:shadow-[0_0_20px_var(--glow-primary-12)]',
  ...
  'dsa-trace': {
    ...
    glowClass: 'hover:shadow-[0_0_20px_var(--glow-secondary-10)]',
  ...
  lld: {
    ...
    glowClass: 'hover:shadow-[0_0_20px_var(--glow-surface-05)]',
  ...
  hld: {
    ...
    glowClass: 'hover:shadow-[0_0_20px_var(--glow-tertiary-10)]',
