...
### 9.2 — Provider + model selector UI
...
### 9.5 — `/api/rate-limit-status` endpoint
...
### 9.8 — Navbar indicator for active provider
In `Navbar.tsx`:
